...
document.addEventListener("DOMContentLoaded", function () {
	...
	menuItems.forEach((menuItem) => {
		...
		const subsubmenuItems = submenu.querySelectorAll(".subsubmenu-item");

		subsubmenuItems.forEach((submenuItem) => {
			const subsubmenu = submenuItem.querySelector(".subsubsubmenu");
