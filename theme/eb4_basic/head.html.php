                ...
                <div class="row align-items-center position-relative">
                    ...
                    <a href="<?php echo G5_URL; ?>" class="title-logo">
                        ...
                        <?php } else if ($logo == 'image') { ?>
                            ...
                            <?php } else { ?>
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/header-logo.png" class="site-logo" style="width:80px;" alt="<?php echo $config['cf_title']; ?>">
                            <?php } ?>
                            <?php } else { ?>
                        ...
                        <div class="sidebar-left-content">
                            ...
                            <ul class="menu">
                                <li class="menu-item" >
                                    ...
                                    <li class="submenu-item">Subitem 1.2</li>
                                    </ul>
                                </li>
